...
The tool allows users to query a country by name, fetch data, analyze it, and store the results in a report file for future reference.
...
2. Objective
The main objective of this project is to provide a simple, interactive system to analyze country data in real-time using the REST Countries API. Users can:
